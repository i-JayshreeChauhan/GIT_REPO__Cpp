...
Class Message is required to store a text value of type std::string and provide a public getter const string& get_text() which is expected to return this text value. 
...
class Message 
{
    ...
    public: 
        ...
        Message(const string s , int i) //parameterized constructor
        {
            text = s;
            id=i;
        }
        ...
        // Overload < operator for sorting messages by ID
...
class MessageFactory 
{
    ...
    public:
        int counter;   //to assign unique IDs
